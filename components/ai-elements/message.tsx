...
export const Message = ({ className, from, ...props }: MessageProps) => (
  <div
    className={cn(
      "group flex w-full flex-col gap-2 animate-in fade-in slide-in-from-bottom-2 duration-300",
...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:bg-secondary group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-foreground group-[.is-user]:max-w-full",
      "group-[.is-assistant]:text-foreground group-[.is-assistant]:w-full group-[.is-assistant]:max-w-[800px]",
      className
    )}
    {...props}
  >
